    ...
    for i=1:length(fieldNames) ,
        ...
        if length(fieldName)>=5 && (isequal(fieldName(1:5),'sweep') || isequal(fieldName(1:5),'trial')) ,  
            ...
            if doesUserWantSingle ,
                ...
                elseif ismac() && isunix() ,
                    scaledAnalogData = scaledDoubleAnalogDataFromRawMexAppleSilicon(analogDataAsCounts, analogChannelScales, analogScalingCoefficients) ;
                elseif ~ismac() && isunix(),
                    scaledAnalogData = scaledDoubleAnalogDataFromRawMexUbuntu(analogDataAsCounts, analogChannelScales, analogScalingCoefficients) ;
                else
