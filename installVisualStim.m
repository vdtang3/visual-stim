...
uiwait(msgbox({ ...
    ...
    ' ', ...
    'This is the fallback location used when no recent WaveSurfer H5 is', ...
    'detected. When detection succeeds, the log is automatically saved', ...
    'beside that H5. You can change this fallback later in the Session tab.'}, ...
...
if ispc
    installation.session.wavesurferParentDirectory = "D:\ephys\btsp";
end
